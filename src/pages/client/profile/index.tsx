...
export const Profile: FC = () => {
  ...
  const { phone, name, family_name, dni } = formValidator.validate(info);
          ...
          <Form paperProps={{ elevation: 0 }} showActions={false}>
            <Grid container mt={1} rowSpacing={4} columnSpacing={2} pb={5}>
              ...
              <Grid item md={4}>
                <FormControl fullWidth>
                  <TextField
                    onChange={(e) => getter.setClient({ dni: e.target.value })}
                    type="text"
                    value={info?.dni || ""}
                    error={!dni}
                    fullWidth
              ...
              <Grid item md={4}>
                <FormControl fullWidth>
                  <TextField
                    onChange={(e) =>
                      getter.setClient({ phone: e.target.value })
                    }
                    value={info?.phone || ""}
                    required
                    error={!phone.valid}
              ...
              <Grid item md={12} p={2} display="flex" justifyContent="center">
                <Button
                  size="large"
                  sx={{ px: 4, py: 1 }}
                  variant="contained"
